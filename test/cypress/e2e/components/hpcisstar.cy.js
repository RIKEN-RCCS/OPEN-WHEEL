describe("04:コンポーネントの基本機能動作確認", ()=>{
   ...
   */
  it("04-01-276:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-プロパティが表示されることを確認", ()=>{
   ...
   */
  it("04-01-277:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-name入力テキストエリアが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-278:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-name入力-nameが入力できることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-279:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-name入力（使用可能文字確認）-nameが入力できないことを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    const INPUT_OBJ_CY = "[data-cy=\"component_property-name-text_field\"]";
   ...
   */
  it("04-01-280:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-description入力テキストエリアが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-281:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-description入力-descriptionが入力できることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-282:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-input files表示-input files入力テキストエリアが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-283:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-input files入力-input filesが入力できることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-284:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-input files反映確認-input filesが反映されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-285:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-output files表示-output files入力テキストエリアが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-286:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-output files入力-output filesが入力できることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-287:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-output files反映確認-output filesが反映されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-288:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-構成要素の機能確認-closeボタン押下-プロパティが表示されていないことを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.closeProperty();
  ...
  skip:issue#948
   */
  it.skip("04-01-289:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-構成要素の機能確認-cleanボタン押下-最新の保存状態に戻っていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-290:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル転送設定の各パターンの確認-接続確認-コンポーネントが接続されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    const INPUT_OBJ_CY = "[data-cy=\"component_property-name-text_field\"]";
   ...
   */
  it("04-01-291:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-転送対象ファイル・フォルダの設定-削除ボタン表示確認（input file）-削除ボタンが表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.enterInputOrOutputFile(TYPE_INPUT, "testInputFile", true, true);
  ...
  試験確認内容：削除ボタンが表示されることを確認
   */
  it("04-01-292:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-転送対象ファイル・フォルダの設定-削除ボタン表示確認（output file）-削除ボタンが表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.enterInputOrOutputFile(TYPE_OUTPUT, "testOutputFile", true, true);
    cy.get("[data-cy=\"action_row-delete-btn\"]").should("be.visible");
  });
  ...
  skip:issue#942
   */
  it.skip("04-01-293:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-転送対象ファイル・フォルダの設定-削除反映確認（input file）-input fileが削除されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.enterInputOrOutputFile(TYPE_INPUT, "testInputFile", true, true);
  ...
  skip:issue#942
   */
  it.skip("04-01-294:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-転送対象ファイル・フォルダの設定-削除反映確認（output file）-output fileが削除されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.enterInputOrOutputFile(TYPE_OUTPUT, "testOutputFile", true, true);
    cy.get("[data-cy=\"action_row-delete-btn\"]").click();
    cy.get("[data-cy=\"graph-component-row\"]").contains("testOutputFile")
   ...
   */
  it("04-01-295:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ディレクトリ単体表示-ディレクトリが単体表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
  ...
  試験確認内容：ディレクトリが単体表示されることを確認
   */
  it("04-01-296:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ディレクトリ複数表示（リロード前）-ディレクトリが単体表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
   ...
   */
  it("04-01-297:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ディレクトリ複数表示（リロード後）-ディレクトリが複数表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
    cy.createDirOrFile(TYPE_DIR, "test1", true);
    cy.createDirOrFile(TYPE_DIR, "test2", false);
   ...
   */
  it("04-01-298:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ファイル単体表示-ファイルが単体表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
    cy.createDirOrFile(TYPE_FILE, "test-a", true);
  ...
  試験確認内容：ファイルが単体表示されることを確認
   */
  it("04-01-299:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ファイル複数表示（リロード前）-ファイルが単体表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
   ...
   */
  it("04-01-300:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ファイル複数表示（リロード後）-ファイルが複数表示されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
    cy.createDirOrFile(TYPE_FILE, "test1", true);
    cy.createDirOrFile(TYPE_FILE, "test2", false);
   ...
   */
  it("04-01-301:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ディレクトリ内ディレクトリ表示-ディレクトリ内にディレクトリが作成されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
    cy.createDirOrFile(TYPE_DIR, "test-a", true);
    cy.get("[data-cy=\"file_browser-treeview-treeview\"]").contains("test-a")
   ...
   */
  it("04-01-302:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-ファイル操作エリア-ディレクトリ内ファイル表示-ディレクトリ内にファイルが作成されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type(wheelPath);
    cy.createDirOrFile(TYPE_DIR, "test-a", true);
    cy.get("[data-cy=\"file_browser-treeview-treeview\"]").contains("test-a")
   ...
   */
  it("04-01-303:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネントの追加/削除確認-該当コンポーネント削除確認-コンポーネントが削除されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-304:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネント特有のプロパティ確認-host表示確認-hostセレクトボックスが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-306:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネント特有のプロパティ確認-hostファイル選択表示確認-hostセレクトボックスで選択したファイルが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    //新規リモートホスト設定を作成
    cy.visit("/remotehost");
    cy.get("[data-cy=\"remotehost-new_remote_host_setting-btn\"]").click();
   ...
   */
  it("04-01-307:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネント特有のプロパティ確認-directory path表示確認-directory pathテキストボックスが表示されていることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-308:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネント特有のプロパティ確認-directory path入力確認-directory pathが入力できることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
   ...
   */
  it("04-01-309:コンポーネントの基本機能動作確認-HPCISS-tarコンポーネント共通機能確認-各コンポーネント特有のプロパティ確認-directory path入力反映確認-directory pathが反映されることを確認", ()=>{
    cy.createComponent(DEF_COMPONENT_HPCISS, HPCISS_NAME_0, 300, 500);
    cy.get("[data-cy=\"component_property-directory_path-text_field\"]").type("test/test");
    cy.closeProperty();
    cy.clickComponentName(HPCISS_NAME_0);

describe("components", ()=>{
  ...
  試験確認内容：name入力テキストエリアが表示されていることを確認
     */
    it.skip("name入力テキストエリアが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：nameが入力できることを確認
     */
    it.skip("name入力-nameが入力できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：nameが入力できないことを確認
     */
    it.skip("name入力（使用可能文字確認）-nameが入力できないことを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      const INPUT_OBJ_CY = "[data-cy=\"component_property-name-text_field\"]";
      cy.get(INPUT_OBJ_CY).find("input")
  ...
  試験確認内容：説明入力テキストエリアが表示されていることを確認
     */
    it.skip("description入力テキストエリアが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：descriptionが入力できることを確認
     */
    it.skip("description入力-descriptionが入力できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：input files入力テキストエリアが表示されていることを確認
     */
    it.skip("input files表示-input files入力テキストエリアが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：input filesが入力できることを確認
     */
    it.skip("input files入力-input filesが入力できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：input filesが反映されることを確認
     */
    it.skip("input files反映確認-input filesが反映されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：output files入力テキストエリアが表示されていることを確認
     */
    it.skip("output files表示-output files入力テキストエリアが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：output filesが入力できることを確認
     */
    it.skip("output files入力-output filesが入力できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：output filesが反映されることを確認
     */
    it.skip("output files反映確認-output filesが反映されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：コンポーネントが接続されていることを確認
     */
    it.skip("ファイル転送設定の各パターンの確認-接続確認-コンポーネントが接続されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.enterInputOrOutputFile(TYPE_OUTPUT, "testOutputFile", true, true);
  ...
  試験確認内容：削除ボタンが表示されることを確認
     */
    it.skip("転送対象ファイル・フォルダの設定-削除ボタン表示確認（input file）-削除ボタンが表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.enterInputOrOutputFile(TYPE_INPUT, "testInputFile", true, true);
  ...
  試験確認内容：削除ボタンが表示されることを確認
     */
    it.skip("転送対象ファイル・フォルダの設定-削除ボタン表示確認（output file）-削除ボタンが表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.enterInputOrOutputFile(TYPE_OUTPUT, "testOutputFile", true, true);
      cy.get("[data-cy=\"action_row-delete-btn\"]").should("be.visible");
  ...
  試験確認内容：ディレクトリが単体表示されることを確認
     */
    it.skip("ファイル操作エリア-ディレクトリ単体表示-ディレクトリが単体表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：ディレクトリが単体表示されることを確認
     */
    it.skip("ファイル操作エリア-ディレクトリ複数表示（リロード前）-ディレクトリが単体表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：ディレクトリが複数表示されることを確認
     */
    it.skip("ファイル操作エリア-ディレクトリ複数表示（リロード後）-ディレクトリが複数表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_DIR, "test1", true);
      cy.createDirOrFile(TYPE_DIR, "test2", false);
  ...
  試験確認内容：ファイルが単体表示されることを確認
     */
    it.skip("ファイル操作エリア-ファイル単体表示-ファイルが単体表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：ファイルが単体表示されることを確認
     */
    it.skip("ファイル操作エリア-ファイル複数表示（リロード前）-ファイルが単体表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：ファイルが複数表示されることを確認
     */
    it.skip("ファイル操作エリア-ファイル複数表示（リロード後）-ファイルが複数表示されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_FILE, "test1", true);
      cy.createDirOrFile(TYPE_FILE, "test2", false);
  ...
  試験確認内容：ディレクトリ内にディレクトリが作成されることを確認
     */
    it.skip("ファイル操作エリア-ディレクトリ内ディレクトリ表示-ディレクトリ内にディレクトリが作成されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_DIR, "test-a", true);
      cy.get("[data-cy=\"file_browser-treeview-treeview\"]").contains("test-a")
  ...
  試験確認内容：ディレクトリ内にファイルが作成されることを確認
     */
    it.skip("ファイル操作エリア-ディレクトリ内ファイル表示-ディレクトリ内にファイルが作成されることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_DIR, "test-a", true);
      cy.get("[data-cy=\"file_browser-treeview-treeview\"]").contains("test-a")
  ...
  試験確認内容：scriptセレクトボックスが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-script表示確認-scriptセレクトボックスが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：checker scriptセレクトボックスが表示されていないことを確認
     */
    it.skip("プロパティ設定確認-checker script非表示確認-checker scriptセレクトボックスが表示されていないことを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：scriptセレクトボックスで選択したファイルが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-scriptファイル選択表示確認-scriptセレクトボックスで選択したファイルが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_FILE, "test-a", true);
  ...
  試験確認内容：scriptセレクトボックスで選択したファイルが反映されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-scriptファイル選択反映確認-scriptセレクトボックスで選択したファイルが反映されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.createDirOrFile(TYPE_FILE, "test-a", true);
      let targetDropBoxCy = "[data-cy=\"component_property-script-autocomplete\"]";
  ...
  試験確認内容：dependencyFormテキストボックスが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-dependencyForm表示確認-dependencyFormテキストボックスが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-stepjob_task-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-use_dependency-switch\"]").find("input")
  ...
  試験確認内容：dependencyFormテキストボックスが入力できることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-dependencyForm入力確認-dependencyFormテキストボックスが入力できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-stepjob_task-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-use_dependency-switch\"]").find("input")
  ...
  試験確認内容：includeテキストボックスが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-include表示確認-includeテキストボックスが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
  ...
  試験確認内容：入力した値が表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-include入力確認-入力した値が表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
  ...
  試験確認内容：入力した値が反映されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-include入力反映確認-入力した値が反映されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-include-list_form\"]").find("input")
  ...
  試験確認内容：excludeテキストボックスが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-exclude表示確認-excludeテキストボックスが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
  ...
  試験確認内容：入力した値が表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-exclude入力確認-入力した値が表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
  ...
  試験確認内容：入力した値が反映されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-exclude入力反映確認-入力した値が反映されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-exclude-list_form\"]").find("input")
  ...
  試験確認内容：各ラジオボタンが表示されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-clean up flag表示確認-各ラジオボタンが表示されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
  ...
  試験確認内容：各ラジオボタンが選択できることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-clean up flag入力確認-各ラジオボタンが選択できることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-remove-radio\"]").find("input")
  ...
  試験確認内容：remove filesが設定されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-clean up flag入力反映確認（remove files）-remove filesが設定されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-remove-radio\"]").find("input")
  ...
  試験確認内容：keep filesが設定されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-clean up flag入力反映確認（keep files）-keep filesが設定されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-keep-radio\"]").find("input")
  ...
  試験確認内容：same as parentが設定されていることを確認
     */
    it.skip("各コンポーネント特有のプロパティ確認-clean up flag入力反映確認（same as parent）-same as parentが設定されていることを確認", ()=>{
      cy.createStepjobComponentAndDoubleClick(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 501, 500);
      cy.createComponent(DEF_COMPONENT_STEPJOB_TASK, STEPJOB_TASK_NAME_0, 501, 500);
      cy.get("[data-cy=\"component_property-remote_file-panel_title\"]").click();
      cy.get("[data-cy=\"component_property-same-radio\"]").find("input")

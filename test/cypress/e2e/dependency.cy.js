describe("06:ディペンデンシー&データリンク接続状態のワークフロー作成動作確認", () => {
    ...
    */
    it("06-01-001:ディペンデンシー&データリンク接続状態のワークフロー作成動作確認-ワークフロー作成動作確認-全コンポーネントを接続させたワークフロー作成時の動作確認-Viewer/Source/Storage/StepJobTaskを除く全コンポーネントの接続確認-コンポーネントが接続されていることを確認", () => {
        cy.createComponent(DEF_COMPONENT_TASK, TASK_NAME_0, 300, 300);
        cy.createComponent(DEF_COMPONENT_IF, IF_NAME_0, 300, 350);
        ...
        cy.createComponent(DEF_COMPONENT_FOR, FOR_NAME_0, 300, 400);
        ...
        cy.createComponent(DEF_COMPONENT_WHILE, WHILE_NAME_0, 300, 480);
        ...
        cy.createComponent(DEF_COMPONENT_FOREACH, FOREACH_NAME_0, 300, 550);
        ...
        cy.createComponent(DEF_COMPONENT_PS, PS_NAME_0, 300, 650);
        ...
        cy.createComponent(DEF_COMPONENT_WORKFLOW, WORKFLOW_NAME_0, 300, 720);
        ...
        cy.createComponent(DEF_COMPONENT_STEPJOB, STEPJOB_NAME_0, 300, 820);
        ...
        cy.createComponent(DEF_COMPONENT_BJ_TASK, BJ_TASK_NAME_0, 300, 900);

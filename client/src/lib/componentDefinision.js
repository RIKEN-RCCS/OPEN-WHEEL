...
export default function () {
  return {
    task: { color: "#3B55B3", img: require("@/assets/img_task.png") },
    taskAndUsejobscheluler: { color: "#3B55B3", img: require("@/assets/img_task_job.png") },
    remotetask: { color: "#3B55B3", img: require("@/assets/img_remotetask.png") },
    remotetaskAndUsejobscheluler: { color: "#3B55B3", img: require("@/assets/img_remotetask_job.png") },
    if: { color: "#5B5B5F", img: require("@/assets/img_if.png") },
    ...
    storage: { color: "#00b8a0", img: require("@/assets/img_storage.png") },

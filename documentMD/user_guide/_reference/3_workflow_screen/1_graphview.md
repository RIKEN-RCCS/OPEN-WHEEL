...
|2|pause project ボタン    |プロジェクトを一時停止します|
|3|stop project ボタン     |プロジェクトの実行を停止し実行前の状態に戻します|
|4|cleanup project ボタン  |プロジェクトの実行中に生成されたファイルなどを削除し、実行開始前の状態に戻します|
...
リポジトリを最後にコミットした時の状態に戻します。<br/><br/>

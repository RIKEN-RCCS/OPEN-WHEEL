...
|3|NEW CLOUD SETTING ボタン       | クラウド上にクラスタを構成する設定を新規作成します                  |
|4|リモートホストリスト           | 登録済みリモートホスト情報がリスト表示されます                      |
|5|TEST ボタン                    | 設定した接続情報でリモートホストにアクセスできるかどうかを確認します|
|6|編集 ボタン                    | 入力済の接続情報を編集します                                        |
|7|削除 ボタン                    | 入力済の接続情報を削除します                                        |

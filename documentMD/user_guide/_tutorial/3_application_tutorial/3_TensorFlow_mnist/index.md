...
また、MNISTデータとは手書き数字画像60,000枚とテスト画像10,000枚を集めた画像データセットであり、
...
### ワークフローの概要
本チュートリアルでは、以下のように2つのタスクコンポーネントを用いています。

trainコンポーネント
: 機械学習モデルを作成する。

estimateコンポーネント
: __train__ コンポーネントで作成したモデルを検証する。
...
### estimateコンポーネントの設定
__estimate__ コンポーネントのスクリプトを作成します。
